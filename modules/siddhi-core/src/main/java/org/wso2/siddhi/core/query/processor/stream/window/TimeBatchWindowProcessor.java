...
@Parameter(name = "windowTime", type = {DataType.INT, DataType.LONG, DataType.TIME}, description = "The batch time period for which the window should hold events")
@Parameter(name = "startTime", type = {DataType.INT}, optional = true, description = "This specifies an offset in milliseconds in order to start the window at a time different to the standard time")
